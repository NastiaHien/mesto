...
// функция скрывает форму редактирования профиля
function closePopup() {
...
// при нажатии на кнопку добавить открывает форму "добавить карточку"
function openAddPhotoPopup() {
  addPhotoPopup.classList.add("popup_opened");
}

// при нажатии на кнопку close (X) закрывает форму "добавить карточку"
...
const formElement = document.querySelector(".popup__form-card");
const nameImageElement = formElement.querySelector(".popup__input_image_name");
const linkImageElement = formElement.querySelector(".popup__input_image_link");
...
cardsContainer.addEventListener("click", function (evt) {
  if (evt.target.classList.contains("gallery__button-like")) {
    ...
    zoomTitle.textContent = evt.target.alt;
    openZoomPhotoPopup();
  }
});
...
function openZoomPhotoPopup() {
  zoomPhotoPopup.classList.add("popup_opened");
}

function closeZoomPhotoPopup() {
  zoomPhotoPopup.classList.remove("popup_opened");
}
